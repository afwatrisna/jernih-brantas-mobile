...
| Batas awal | Maksimum 10 pertanyaan per pengguna per jam pada satu instance aplikasi. |
...
Rate limit saat ini bersifat in-memory sehingga tidak dibagi antar-instance serverless dan akan ter-reset ketika instance berubah. Sebelum fitur digunakan oleh banyak petugas, ganti limiter ini dengan counter yang durable, misalnya di database dengan RLS yang sesuai atau layanan rate limiting terkelola. Pertahankan tanpa web search pada V1 agar jawaban hanya berbasis context monitoring yang dikurasi.
