        ...
        <section className="content">
          ...
          {section === "analytics" && (
            <>
              ...
              <section className="surface-card"><div className="card-heading"><h2>{activeStation.name}</h2><StatusBadge insight={activeInsight} /></div><TrendChart readings={displayRangeHistory} baseline={activeStation.baseline} /><div className="range-stats"><span>Rata-rata {formatNtu(rangeAverage)}</span><span>Min {formatNtu(rangeMin)}</span><span>Max {formatNtu(rangeMax)}</span></div></section>
