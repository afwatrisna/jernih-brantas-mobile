...
type ChatMessage = { id: string; role: "user" | "assistant"; text: string; sourceLabel?: string; knowledgeBase?: { id: string; title: string; sourceCount: number }; sources?: { type: string; label: string }[]; suggestions?: string[] };
...
function getQuickQuestions(stationName: string) {
  return [
    `Tampilkan kondisi ${stationName}`,
    "Lihat tren turbidity",
    "Ada anomaly?",
    "Bandingkan dengan upstream",
    "Status sensor",
  ];
}
